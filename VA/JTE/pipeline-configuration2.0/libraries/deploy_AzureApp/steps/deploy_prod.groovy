...
String deploy_aws_access_key_id = config.deploy_aws_access_key_id
String deploy_aws_secret_access_key = config.deploy_aws_secret_access_key
String deploy_aws_region = config.deploy_aws_region
